...
void capsules_init(void)
{
	...
	strcpy(capsulas[7].nome, " Bunda Mole ");
	strcpy(capsulas[7].tipo_agua, "quente");
	capsulas[7].tempo_agua = 3;
	capsulas[7].temperatura_agua = 50;
	capsulas[7].com_gas = yes;
	capsulas[7].tempo_gas = 2.50;
}
